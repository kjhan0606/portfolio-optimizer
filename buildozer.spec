...
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow,numpy,pandas,matplotlib,requests,certifi,charset-normalizer,idna,urllib3,yfinance,multitasking,peewee,appdirs,frozendict,pytz,six,cycler,kiwisolver,pyparsing,python-dateutil
